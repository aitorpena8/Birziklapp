function BinsContainer(x, y, width, height)
{
    ...
    this.green   = new Bin(0, (height/5 + offset) * 2, "resources/images/sprites/containers/green_256.png", RecycleBins.GREEN);
    this.brown   = new Bin(0, (height/5 + offset) * 3, "resources/images/sprites/containers/brown_256.png", RecycleBins.BROWN);
    this.default = new Bin(0, (height/5 + offset) * 4, "resources/images/sprites/containers/default_256.png", RecycleBins.DEFAULT);
